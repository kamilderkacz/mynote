...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": Sortuj po kolumnie rosnąco",sSortDescending:": Sortuj po kolumnie malejąco"},oPaginate:{sFirst:"Pierwsza",sLast:"Ostatnia",sNext:"Następna",sPrevious:"Poprzednia"},sEmptyTable:"Brak dostępnych danych",sInfo:"Pokazuje od _START_ do _END_ z _TOTAL_ wszystkich",sInfoEmpty:"Showing 0 to 0 of 0 entries",
sInfoFiltered:"(sfiltrowano _MAX_ wszystkich wpisów)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Pokaż _MENU_ wpisów",sLoadingRecords:"Wczytywanie...",sProcessing:"Przetwarzanie...",sSearch:"Szukaj:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nie znaleziono wpisów pasujących do podanych kryteriów."},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
